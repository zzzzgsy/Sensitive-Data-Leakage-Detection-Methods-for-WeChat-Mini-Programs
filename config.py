...
project_prefix = "G:/miniapp/XPOScope-main"
prefix = "G:/miniapp/XPOScope-main/dynamicExerciser"
...
CONFIGS_PROFILE=project_prefix + "/configs/"+"hospital_config.json"
PAGE_TEXT_PATH = prefix + "/data/page_text/" 
MINI_APP_LOG = project_prefix + "/MiniAppLog/"
MITM_DIR = MINI_APP_LOG + "/mitmproxy/"
...
BUFFER_SIZE = 4096
MINI_APP_TEST_TIME = 60 * 6
WORD_PER_ELEMENT = 8
MINI_APP_TYPE = '医疗'
WORK_BOOK = "./AliPay_XPOCheckerMini_TestCases.xls"
# config.py 里追加（按你机器情况改）
WECHAT_EXE = r"C:\Program Files\Tencent\WeChat\WeChat.exe"
WECHAT_TITLE = "微信"
WECHAT_SEARCH_OFFSET_X = 380
WECHAT_SEARCH_OFFSET_Y = -395
WECHAT_RESULT_OFFSET_X = -250
WECHAT_RESULT_OFFSET_Y = -300
WECHAT_VIEW_PADDING = (20, 80, 20, 60)
